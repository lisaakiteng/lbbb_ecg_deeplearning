...
from models_lstm_bidir_fusion import fusion_lstm_bidir
...
OUTPUT_DIR = "outputs_lstm_bidir_fusion"
...
EXPERIMENT_NAME = "exp2_lstm_bidir_fusion"
lrs = [1e-3]
epochs = 60
...
models = [
    ("fusion_lstm_bidir", lambda: fusion_lstm_bidir(n_tab=n_tab)),
]
