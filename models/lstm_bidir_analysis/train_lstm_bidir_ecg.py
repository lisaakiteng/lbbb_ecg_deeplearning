...
from models_lstm_bidir import lstm_bidir_ecg
...
OUTPUT_DIR = "outputs_lstm_bidir_ecg"
...
EXPERIMENT_NAME = "exp2_lstm_bidir_ecg"
lrs = [1e-3]
epochs = 60
...
train_ds = make_ds(train_packed, y_train, training=True)
val_ds   = make_ds(val_packed, y_val)
test_ds  = make_ds(test_packed, y_test)
...
models = [
    ("lstm_bidir_ecg", lambda: lstm_bidir_ecg()),
]
