...
OUTPUT_DIR = "outputs_lstm_fusion_multiseed"
...
EXPERIMENT_NAME = "exp2_lstm_fusion_multiseed"
lrs = [1e-3]
epochs = 60
...
for lr in lrs:
    for seed in seeds:
        set_seed(seed)
        train_ds = make_ds_multi(train_packed, Xtab_train, y_train, training=True, batch_size=32)
