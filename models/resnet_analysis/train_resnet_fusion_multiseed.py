...
OUTPUT_DIR = "outputs_resnet_fusion_multiseed"
...
EXPERIMENT_NAME = "exp3_resnet_medium_k7_fusion_multiseed"
model_name = "fusion_resnet_medium_k7"
...
for lr in lrs:
    for seed in seeds:
        ...
        model = fusion_resnet_medium(n_tab=n_tab, k=7)
...
results_path = os.path.join(
    RESULT_DIR,
    f"{EXPERIMENT_NAME}_all_seed_results.csv",
)
